  ...
  return (
    ...
    <div className="home">
      <div className="jumbotron">
        <h1 className="text-left m-4 display-4 bg-dark text-white d-inline-block font-weight-normal  p-3 animated pulse infinite delay-5s">Conditioning and Cooking</h1>
      </div>
